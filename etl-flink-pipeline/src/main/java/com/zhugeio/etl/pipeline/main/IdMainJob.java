...
//
//
//public class IdMainJob {
//    private static final Logger logger = LoggerFactory.getLogger(IdMainJob.class);
...
//                        source,
//                        new SetAppIdAndBusinessOperator(kvrocksHost, kvrocksPort, true),
